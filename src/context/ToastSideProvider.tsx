...
import { ToastSideContextType } from "./interfaces/ToastSideContextType";
            ...
            <>
                ...
                >   
                    <Alert 
                        ...
                        severity={toast.type == 'error' ? 'error': toast.type == 'warning' ? 'warning' : toast.type == 'success' ? 'success' : 'error'} 
                        sx={{ 
                            width: '100%',
