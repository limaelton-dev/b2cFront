...
import { processCreditCardPayment, validatePayment, formatCreditCardData, detectCardBrand, processPixPayment } from '../api/services/payment';
import { cpfValidation, emailVerify, addPhone, valorFrete, valorFreteDeslogado } from '../api/checkout/services/checkout';
                    ...
                    <div className="d-flex justify-content-between">
                        <div className="prods">
                            {Array.isArray(cartData) && cartData.length > 0 && Array.isArray(cartItems) && cartItems.length > 0 ? cartData.map((item, index) => {
                                ...
                                // Função para obter a referência/SKU do produto
                                ...
                                const getProductCategory = (product) => {
                                    ...
                                    if (product.tipo && product.tipo.tpo_descricao) {
                                        return product.tipo.tpo_descricao;
                                    }
                                ...
                                <div className="prod" key={`${itemId}-${index}`}>
                                    ...
                                    <div className="info-prod">
                                        <span className='title-prod'>{getProductName(product)}</span>
                                        <div className="more-info">
                                            <span className='sku'>SKU: {getProductSku(product)}</span>
                                            ...
                                            <div style={{display: 'flex', marginTop: '4px'}}>
                                                <span style={{marginRight: '8px'}}>Preço unitário: </span>
                                                <span style={{fontWeight: 'bold'}}>
                                                    R$ {(getProductPrice(product, {...item, qty: 1, quantity: 1}) || 0).toFixed(2).replace('.', ',')}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <>
                                        <tr>
                                            ...
                                            <td>{(() => {
                                                ...
                                                return baseTotal.toFixed(2).replace('.', ',');
                                            })()}</td>
                                        </tr>
                                        <tr>
                                            <td>Descontos</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>{(() => {
                                                ...
                                                const discountedTotal = applyDiscounts(baseTotal);
                                                const pixTotal = applyPixDiscount(discountedTotal);
                                                return pixTotal.toFixed(2).replace('.', ',');
                                            })()}</td>
                                        </tr>
                                        <tr>
                                            <td>Entrega</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>{(() => {
                                                ...
                                                const discountedTotal = applyDiscounts(baseTotal);
                                                const finalTotal = discountedTotal + (fretePreco || 0);
