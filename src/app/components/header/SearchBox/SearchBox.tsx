  ...
  return (
    <div className="search">
      <div className="content-search">
        <div role="search">
          <select name="categorias" id="categorias-search" aria-label="Categorias">
            <option value="all" defaultValue="all">Todas categorias</option>
          </select>
          <input
            ref={inputRef}
            type="text"
          ...
          />
          <button type="button" onClick={() => onSubmit(term)} aria-label="Buscar">
